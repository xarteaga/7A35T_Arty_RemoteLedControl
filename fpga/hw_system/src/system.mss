...
BEGIN DRIVER
 PARAMETER DRIVER_NAME = massive_pwm
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = massive_pwm_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = massive_pwm
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = massive_pwm_1
END
...
BEGIN DRIVER
 PARAMETER DRIVER_NAME = uartlite
 PARAMETER DRIVER_VER = 3.0
 PARAMETER HW_INSTANCE = uart_lcd
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = uartlite
 PARAMETER DRIVER_VER = 3.0
 PARAMETER HW_INSTANCE = uart_wifi
END
